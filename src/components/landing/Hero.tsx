...
const Hero = () => {
  return (
    ...
    <section className="relative h-[920px] w-full bg-gradient-to-r from-black/95 to-gray-800 overflow-visible">
      {/* --- BACKGROUND LAYERS --- */}
      
      {/* Layer 1: The Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/hero-bg.jpg" // Make sure to add a background image here
          alt="Background"
          fill
          priority
      ...
      <div className="relative z-10 flex flex-col items-center max-w-5xl mx-auto px-4 pt-40 text-center">
        {/* Badge */}
         <RevealAnimation delay={0.3} direction="down" duration={1.2} offset={60}>
          <span className="inline-block px-4 py-2 rounded-xl border border-[#a22070]/40 bg-black/30 text-gray-400 text-sm font-medium mb-4 tracking-wider backdrop-blur-sm">
        ...
        */}
        <div className="absolute bottom-0 z-20 w-full max-w-[1000px] px-4 left-1/2 -translate-x-1/2 translate-y-1/2">
          <RevealAnimation delay={0.6} direction="down" duration={1.2} offset={60}>
